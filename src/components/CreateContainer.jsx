	...
	return (
		<div className="w-full min-h-screen flex justify-center items-center">
			...
			>
				...
				<div className="w-full py-2 border-b border-gray-300 flex justify-center gap-2">
					...
					<input
						...
						className="w-full h-fll text-lg bg-transparent font-semibold outline-none border-none placeholder:text-gray-400
						text-textColor"
					/>
				</div>
					...
					>
						...
						{categories &&
							categories.map((item) => (
								<option
									key={item.id}
									className="text-base border-0 outline-none capitalize bg-white text-headingColor w-full"
